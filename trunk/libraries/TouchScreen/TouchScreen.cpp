...
TouchScreen::TouchScreen(uint8_t xm, uint8_t xp, uint8_t ym, uint8_t yp, uint8_t port, uint8_t cd, uint8_t wr, uint8_t rd, uint8_t cs, uint8_t reset) {
...
uint16_t TouchScreen::get565Color(uint8_t r, uint8_t g, uint8_t b) {
	uint16_t color;
	color = r >> 3;
	color <<= 6;
	color |= g >> 2;
