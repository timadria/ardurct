...
public class TouchScreen_UserInterface extends ScreenHAL {
	...
	static final int UI_POPUP_SHOWN = 2;
	...
	public void handleUI() {
		...
		// remove the popup if the user has clicked
		if (_uiPopupState == UI_POPUP_APPEARING) {
			...
			if (_uiDebounceSteps >= CONFIGURATION_UI_DEBOUNCE_STEPS) _uiPopupState = UI_POPUP_SHOWN;
			return;
	...
	public void showUIPopup(int[] title, int[] message, int color) {
		...
		// popup the window
		_uiPopupState = UI_POPUP_APPEARING;
