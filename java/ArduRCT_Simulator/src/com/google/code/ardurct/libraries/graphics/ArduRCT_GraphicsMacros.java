...
public class ArduRCT_GraphicsMacros extends ArduRCT_Graphics {
	...
	void _executeMacroCommand(macroCommand_t mc, int x, int y, int scaleMul, int scaleDiv) {
		...
		if (mc.cmd == SCREEN_MACRO_CMD_STRING) {
			...
			drawString(mc.text, sX, sY, _mForegroundColor, _mFontSize, _mIsFontBold, _mIsFontOverlay, 0, false);
